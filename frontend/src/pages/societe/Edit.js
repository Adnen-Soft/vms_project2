...
const SocieteEditPage = (props) => {
	...
	if(pageReady){
		return (
<main id="SocieteEditPage" className="main-page">
    { (props.showHeader) && 
...
SocieteEditPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'societe',
	apiPath: 'societe/edit',
	routeName: 'societeedit',
...
export default SocieteEditPage;
