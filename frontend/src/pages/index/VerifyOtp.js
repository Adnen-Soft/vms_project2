						...
						<div className="card">
							<div className="mb-4">
								<div className="grid align-items-center justify-content-between">
									...
									<div className="col">
										<div className="text-2xl font-bold">Vérification OTP</div>
									</div>
									<div className="col-3">
							...
							<form onSubmit={formik.handleSubmit}>
								<div className="grid justify-content-between">
									<div className="col">
										<InputText name="otp_code" id="otp_code" className={classNames('w-full text-center otp-input', getErrorClass('otp_code'))} placeholder="Entrez OTP" value={formik.values.otpCode} onChange={formik.handleChange} type="text" />
										{getFieldError('otp_code')}
									</div>
									<div className="col-3 tetx-right">
										<Button className="p-button-lg" loading={loading} type="submit" label="Vérifier" />
									</div>
								</div>
