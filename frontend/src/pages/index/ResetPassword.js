					...
					<div className="card">
						...
						<form onSubmit={formik.handleSubmit}>
							<div className="formgrid mb-3">
								<Password inputClassName="w-full" className={classNames('w-full', getErrorClass('password'))} name="password" id="password" feedback toggleMask value={formik.values.password} onChange={formik.handleChange} placeholder="nouveau mot de passe" />
								{getFieldError('password')}
							</div>
							<div className="formgrid mb-3">
								<Password inputClassName="w-full" className={classNames('w-full', getErrorClass('confirm_password'))} name="confirm_password" id="confirm_password" feedback={false} toggleMask value={formik.values.confirm_password} onChange={formik.handleChange} placeholder="Confirmer le nouveau mot de passe"
							 />
