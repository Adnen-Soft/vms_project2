				...
				<div className="col-12 md:col-6">
					<div className="card text-center">
						...
						<div className="text-500">
							Veuillez vérifier votre adresse e-mail en suivant le lien dans votre boîte aux lettres
						</div>
						<hr />
						{errorMsg && <Message className="my-3" severity="error" text={errorMsg} />} 
						<form onSubmit={formik.handleSubmit}>
							<div className="text-center">
								<Button label="Ré-envoyer l'email" type="submit" icon="pi pi-envelope" loading={loading} />
							</div>
						</form>
					</div>
				</div>
