...
const VehiculeEditPage = (props) => {
	...
	if(pageReady){
		return (
<main id="VehiculeEditPage" className="main-page">
    { (props.showHeader) && 
...
VehiculeEditPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'vehicule',
	apiPath: 'vehicule/edit',
	routeName: 'vehiculeedit',
...
export default VehiculeEditPage;
