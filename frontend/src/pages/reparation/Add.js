...
const ReparationAddPage = (props) => {
	...
	if(pageReady){
		return (
<main id="ReparationAddPage" className="main-page">
    { (props.showHeader) && 
...
ReparationAddPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'reparation',
	apiPath: 'reparation/add',
	routeName: 'reparationadd',
...
export default ReparationAddPage;
