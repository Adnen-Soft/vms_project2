...
const CarburantEditPage = (props) => {
	...
	if(pageReady){
		return (
<main id="CarburantEditPage" className="main-page">
    { (props.showHeader) && 
...
CarburantEditPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'carburant',
	apiPath: 'carburant/edit',
	routeName: 'carburantedit',
...
export default CarburantEditPage;
