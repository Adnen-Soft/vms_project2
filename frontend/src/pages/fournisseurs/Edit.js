...
const FournisseursEditPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="FournisseursEditPage" className="main-page">
    { (props.showHeader) && 
...
FournisseursEditPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'fournisseurs',
	apiPath: 'fournisseurs/edit',
	routeName: 'fournisseursedit',
...
export default FournisseursEditPage;
