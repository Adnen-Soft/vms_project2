...
import FournisseursEditPage from 'pages/fournisseurs/Edit';
import useApp from 'hooks/useApp';

import useViewPage from 'hooks/useViewPage';
const FournisseursViewPage = (props) => {
		const app = useApp();
	...
	function ActionButton(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog(<FournisseursEditPage isSubPage apiPath={`/fournisseurs/edit/${data.id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	if(pageReady){
		return (
			<div>
<main id="FournisseursViewPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title="Vue Fournisseur"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div >
                        ...
                        <div className="mb-3 grid ">
                            ...
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        <div className="text-400 font-medium mb-1">Nom</div>
                            ...
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        <div className="text-400 font-medium mb-1">Telephone</div>
                            ...
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        <div className="text-400 font-medium mb-1">Adresse</div>
...
FournisseursViewPage.defaultProps = {
	id: null,
	primaryKey: 'id',
	pageName: 'fournisseurs',
	apiPath: 'fournisseurs/view',
	routeName: 'fournisseursview',
...
export default FournisseursViewPage;
