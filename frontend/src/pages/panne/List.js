...
const PanneListPage = (props) => {
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/panne/view/${data.id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/panne/edit/${data.id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function IdTemplate(data){
		if(data){
			return (
				<Link to={`/panne/view/${data.id}`}> { data.id }</Link>
			);
		}
	}
	...
	function StatutTemplate(data){
		if(data){
			return (
				<><Chip label={data.statut} /></>
			);
		}
	}
	...
	return (
<main id="PanneListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Panne"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="priorite" header="Priorite"   ></Column>
