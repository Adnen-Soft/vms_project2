...
import DepartementEditPage from 'pages/departement/Edit';
import useApp from 'hooks/useApp';

import useViewPage from 'hooks/useViewPage';
const DepartementViewPage = (props) => {
		const app = useApp();
	...
	function ActionButton(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog(<DepartementEditPage isSubPage apiPath={`/departement/edit/${data.id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	if(pageReady){
		return (
			<div>
<main id="DepartementViewPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title="Vue Departement"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
DepartementViewPage.defaultProps = {
	id: null,
	primaryKey: 'id',
	pageName: 'departement',
	apiPath: 'departement/view',
	routeName: 'departementview',
