...
const DepartementEditPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="DepartementEditPage" className="main-page">
    { (props.showHeader) && 
...
DepartementEditPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'departement',
	apiPath: 'departement/edit',
	routeName: 'departementedit',
...
export default DepartementEditPage;
